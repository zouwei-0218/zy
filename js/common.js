 ...
 */
function toWhatsApp(){
    window.open('https://wa.me/message/NLQDVBCLKV7WF1', '_blank')
}
...
function initGlobalModal() {
    ...
    const logoPath = isInSubfolder ? '../static/images/index/logo1.png' : './static/images/index/logo1.png';
